            ...
            <nav class="main-navigation">
                <ul>
                    ...
                    <li <?php if (get_post_type() == 'post') echo 'class="current-menu-item"' ?>><a
                                href="<?php echo site_url('/index.php/blog'); ?>">Blog</a></li>
                </ul>
            </nav>
            <div class="site-header__util">
                <?php if (is_user_logged_in()) { ?>
                    <a href="<?php echo esc_url(site_url('/index.php/my-notes')); ?>"
                ...
                <a href="<?php echo esc_url(site_url('/index.php/search')); ?>" class="search-trigger js-search-trigger"><i
                            class="fa fa-search" aria-hidden="true"></i></a>
            </div>
        </div>
    </div>
